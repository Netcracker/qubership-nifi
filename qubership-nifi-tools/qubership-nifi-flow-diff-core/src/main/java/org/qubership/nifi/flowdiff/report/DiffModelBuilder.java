...
import org.qubership.nifi.flowdiff.compare.FlowComparator;
...
public final class DiffModelBuilder {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(DiffModelBuilder.class);
