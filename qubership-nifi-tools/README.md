...
| `qubership-nifi-tools-nifi-common`                                                               | Reusable NiFi HTTP, TLS, authentication, URI, version, and component-catalog client library shared by the export and Knowledge Base tools.                                               |
