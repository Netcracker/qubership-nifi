...
| [`qubership-nifi-kb-builder-tool`](qubership-nifi-kb-builder-tool/README.md)                     | Command-line tool that builds a portable, version-matched NiFi Knowledge Base (Markdown and JSON) from a running NiFi instance for an AI agent. Read-only; supports NiFi 2.5.0 to 3.0.0.                |
| [`qubership-nifi-tools-nifi-common`](qubership-nifi-tools-nifi-common/README.md)                 | Library for talking to the NiFi 2.x REST API: TLS, authentication, bounded HTTP transport, URI resolution, version detection, and component-catalog retrieval.                                          |
