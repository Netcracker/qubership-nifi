 ...
 * or a {@code bundle}-named processor property is not misclassified.
 */
public final class ChangeCategorizer {
     ...
     * @param context the owner node on a side where the field is present, used for structural checks such as bundle
     *                detection
