...
| `Scheduling strategy = Event driven`              | `apply_csv_transforms` - switches the processor to `TIMER_DRIVEN`; Concurrent Tasks is raised from 0 to 4 and flagged for review, any other value is kept                                                                   |
