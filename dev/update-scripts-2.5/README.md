# Upgrade Script for Apache NiFi 2.5.0

## Scripts overview

The script `analyzeAndUpdateNiFiExports.sh` upgrades controller services and reporting tasks exports
done from older NiFi versions to be compatible with NiFi 2.5.0.
...
| pathToUpdateNiFiConfig | Y        | ./upgradeConfig_2_5.json | Path to mapping config.                                     |
