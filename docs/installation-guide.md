...
The example below starts the service with mTLS authentication and encrypted HTTPS communication.
...
4. Run `docker compose -f docker-compose.yaml up -d --wait --wait-timeout 180`.
