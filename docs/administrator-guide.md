...
| SENSITIVE_KEY                                        | N                                  |                              | Deprecated key used for encrypting sensitive properties in the NiFi configuration (flow.json.gz). Replaced with `NIFI_NEW_SENSITIVE_KEY`.                                                                                                                                                                              |
| SENSITIVE_KEY_PATH                                   | N                                  |                              | The path to file with the deprecated key used for encrypting sensitive properties in the NiFi configuration (flow.json.gz).                                                                                                                                                                                            |
| OLD_SENSITIVE_KEY                                    | N                                  |                              | Deprecated previous key used for encrypting sensitive properties in the NiFi configuration (flow.json.gz).                                                                                                                                                                                                             |
| OLD_SENSITIVE_KEY_PATH                               | N                                  |                              | The path to file with the deprecated previous key used for encrypting sensitive properties in the NiFi configuration (flow.json.gz).                                                                                                                                                                                   |
...
| Deprecated NiFi sensitive key          | File      | `$SENSITIVE_KEY_PATH`                            | Contains the key used for encrypting sensitive properties in the NiFi configuration. File-based alternative to `SENSITIVE_KEY` env variable. Will be used only if `SENSITIVE_KEY` is not set.                                                                                                                                                              |
| Deprecated previous NiFi sensitive key | File      | `$OLD_SENSITIVE_KEY_PATH`                        | Contains the previous key used for encrypting sensitive properties in the NiFi configuration. File-based alternative to `OLD_SENSITIVE_KEY` env variable. Will be used only if `OLD_SENSITIVE_KEY` is not set.                                                                                                                                             |
