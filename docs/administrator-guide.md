...
| KEY_PASSWORD                                         | N                                  |                              | The key password for secret key stored in the keystore. May contain any printable characters except for `\` (backslash). Either `KEY_PASSWORD` or `NIFI_KEY_PASSWORD_PATH` must be set, if `AUTH` = oidc or tls or ldap.                                                                                               |
| NIFI_KEY_PASSWORD_PATH                               | N                                  |                              | The path to file with the key password for secret key stored in the keystore. Either `KEY_PASSWORD` or `NIFI_KEY_PASSWORD_PATH` must be set, if `AUTH` = oidc or tls or ldap.                                                                                                                                          |
...
| Truststore password                | File      | `$NIFI_TRUSTSTORE_PASSWORD_PATH`                 | Contains the truststore keystore password. File-based alternative to `TRUSTSTORE_PASSWORD` env variable. Will be used only if `TRUSTSTORE_PASSWORD` is not set.                                                                                                                                                                                            |
