...
| NAR Repository                         | Directory | /opt/nifi/nifi-current/persistent_conf/nar_repository | Storage for NAR Repository holding custom NARs loaded via REST API.                                                                                                                                                                                                                                                                                  |
| Assets                                 | Directory | /opt/nifi/nifi-current/persistent_conf/assets    | Storage for Assets, files used by Apache NiFi flows, loaded via API.                                                                                                                                                                                                                                                                                       |
| Connector Assets                       | Directory | /opt/nifi/nifi-current/persistent_conf/connector_assets | Storage for Connector-related Assets, files used by Apache NiFi flows managed by Connectors, loaded via API.                                                                                                                                                                                                                                          |
| Python Working Directory               | Directory | /opt/nifi/nifi-current/persistent_conf/work/python | Storage for extracted Python extension virtual environments and dependencies.                                                                                                                                                                                                                                                                        |
